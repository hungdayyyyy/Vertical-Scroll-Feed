    ...
    <div className="page-scroll">
      ...
      <div className="explore-search-wrap">
        <div className="explore-search">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="18" height="18" style={{ flexShrink: 0, opacity: 0.5 }}>
      ...
      <section className="page-section">
        ...
        <div className="tag-grid">
          {trendingTags.map((t) => (
            <button key={t.tag} className="tag-card" style={{ "--tag-color": t.coverColor } as React.CSSProperties}>
        ...
        <div className="user-list">
          {suggestedUsers.map((u) => (
            <div key={u.id} className="user-row">
              <div className="user-avatar" style={{ background: u.color }}>{u.initial}</div>
              <div className="user-meta">
                <span className="user-name">{u.name}</span>
                <span className="user-handle">{u.handle} · {u.followers} người theo dõi</span>
              </div>
